...
/** Additive conversation model; the legacy chat_messages table is retained. */
@Entity(
...
data class ChatConversationV2Entity(
    ...
    @ColumnInfo(name = "server_conversation_id") val serverConversationId: String? = null,
    @ColumnInfo(name = "family_id") val familyId: String? = null,
    @ColumnInfo(name = "type") val type: String,
    @ColumnInfo(name = "title") val title: String? = null,
    @ColumnInfo(name = "legacy_child_id") val legacyChildId: Long? = null,
    ...
    @ColumnInfo(name = "last_sequence") val lastSequence: Long = 0,
    @ColumnInfo(name = "last_read_sequence") val lastReadSequence: Long = 0,
