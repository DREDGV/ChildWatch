...
data class ChatMessageV2Entity(
    ...
    @ColumnInfo(name = "server_message_id") val serverMessageId: String? = null,
    @ColumnInfo(name = "client_message_id") val clientMessageId: String? = null,
    @ColumnInfo(name = "server_sequence") val serverSequence: Long? = null,
    @ColumnInfo(name = "conversation_id") val conversationId: String,
    @ColumnInfo(name = "legacy_row_id") val legacyRowId: Long? = null,
    @ColumnInfo(name = "sender_member_id") val senderMemberId: String? = null,
    @ColumnInfo(name = "sender_device_id") val senderDeviceId: String? = null,
    @ColumnInfo(name = "sender_display_name") val senderDisplayName: String? = null,
    @ColumnInfo(name = "sender_role") val senderRole: String? = null,
    ...
    @ColumnInfo(name = "legacy_message_id") val legacyMessageId: String? = null,
